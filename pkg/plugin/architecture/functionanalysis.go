...
func (analyzer *analyzer) loadTypedPackages(
	ctx context.Context,
	sourcePaths []string,
) (*token.FileSet, []*packages.Package, error) {
	...
	return fileSet, loadedPackages, nil
}
