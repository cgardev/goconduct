...
func SchemaDefinition() conf.SchemaDefinition {
	...
	fields["quality.crap"] = conf.FieldDefinition{Description: "crap4go execution and score limits."}
	fields["quality.crap.command"] = conf.FieldDefinition{Description: "crap4go executable.", Default: "crap4go"}
	fields["quality.crap.testCommand"] = conf.FieldDefinition{Description: "Optional test command passed to crap4go."}
	...
	fields["quality.crap.maxWorkers"] = conf.FieldDefinition{Description: "Optional crap4go worker count.", Minimum: conf.Pointer(0.0)}
	fields["quality.crap.pathPolicies"] = conf.FieldDefinition{Description: "Path-specific CRAP score thresholds."}
	fields["quality.duplication"] = conf.FieldDefinition{Description: "dry4go execution and duplicate limits."}
	fields["quality.duplication.command"] = conf.FieldDefinition{Description: "dry4go executable.", Default: "dry4go"}
	...
	fields["quality.mutation"] = conf.FieldDefinition{Description: "mutate4go execution and mutation limits."}
	fields["quality.mutation.command"] = conf.FieldDefinition{Description: "mutate4go executable.", Default: "mutate4go"}
	fields["quality.mutation.paths"] = conf.FieldDefinition{Description: "Production Go paths selected for mutation."}
	fields["quality.mutation.execute"] = conf.FieldDefinition{Description: "Execute mutations instead of scanning sites.", Default: false}
	fields["quality.mutation.reuseCoverage"] = conf.FieldDefinition{Description: "Reuse existing mutate4go coverage data."}
	fields["quality.mutation.sinceLastRun"] = conf.FieldDefinition{Description: "Select functions changed since the last manifest."}
	fields["quality.mutation.mutateAll"] = conf.FieldDefinition{Description: "Ignore manifest change selection."}
	fields["quality.mutation.testCommand"] = conf.FieldDefinition{Description: "Optional test command passed to mutate4go."}
	fields["quality.mutation.maxWorkers"] = conf.FieldDefinition{Description: "Optional mutate4go worker count.", Minimum: conf.Pointer(0.0)}
